...
let VPS_CHANGE_OF_PLAN = BASE_URL + "vpschangeofplan"
let CHANGE_OF_PLAN_FUND = BASE_URL + "changeofplanfund"
...
let TRANSACTION_SUBMISSION_VPS = BASE_URL + "TransactionSubmissionVps"
