...
import Foundation
protocol QuestionaireInteractorProtocol: AnyObject {
...
class QuestionaireInteractor: QuestionaireInteractorProtocol {
    var presenter: QuestionairePresenterProtocol?
