...
class InvestNowVC: UIViewController {
...
extension InvestNowVC: UIPickerViewDelegate, UIPickerViewDataSource {
...
extension InvestNowVC: UITextFieldDelegate {
...
extension InvestNowVC: CityProtocol {
